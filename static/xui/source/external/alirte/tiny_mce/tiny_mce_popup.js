...
(function(d) {
	...
	a.src = 'http://test.static.com:2442/itbu/ftrade/xui/source/external/alirte/tiny_mce/tiny_mce_src.js';
...
tinyMCEPopup={
	...
	requireLangPack:function(){
		...
		if(a&&b.editor.settings.language&&b.features.translate_i18n!==false){
			...
			if(!!tinyMCE.settings.custom_i18n){
				tinymce.each(tinyMCE.settings.custom_i18n, function(o, p){
	...
	showErrorMsg:function(e){
		var d=document.getElementById('msgInfo');
		if(!d){
