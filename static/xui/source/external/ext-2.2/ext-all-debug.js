...
El.collectorThread = setInterval(El.garbageCollect, 30000);
...
Ext.extend(Ext.tree.TreeDropZone, Ext.dd.DropZone, {
    ...
    getDropPoint : function(e, n, dd){
        ...
        var y = Ext.lib.Event.getPageY(e);
         //此处做修改，将是否是叶子节点判断去掉|| tn.isLeaf(),在压缩版本中为||J.isLeaf()
      ...
      var mb = this.scroller.dom;
        ...
        for(var j = 0, len = rs.length; j < len; j++){
            ...
            for(var i = 0; i < colCount; i++){
                ...
                p.attr = p.cellAttr = "";
                p.value = c.renderer(r.data[c.name], p, r, rowIndex, i, ds, this.grid.colModel);
                p.style = c.style;
...
Ext.debug.HtmlNode = function(){
	...
	Ext.BLANK_IMAGE_URL = 'https://image.alisoft.com/trade/xplatform/js/xui/external/ext-2.2/resources/images/default/s.gif';
