...
xui.widgets.Tip = function() {
	...
	return {		
		...
		*/
		htmlTmp:'<ul class="xui-tip-ul" id="#uid" onmouseover="xui.widgets.Tip._close(\'#uid\')"><li class="xui-tip-left"></li>'
				+'<li class="xui-tip-bg"><table><tr><td height="25" valign="middle">#msg</td></tr></table></li>'
				+'<li class="xui-tip-right"><span class="xui-tip-btn"></span></li></ul>', 
		/**
		 * （在某个对象上）显示提示
		...
		show: function(id, msg,html,model){
			...
			layer.style.left = (xy[0]+2) + 'px';
			layer.style.top = (xy[1]-35) + 'px';
